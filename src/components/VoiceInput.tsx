  ...
  return (
    <div className={`relative ${className}`}>
      <button
        ...
        className={`flex items-center justify-center w-full p-4 rounded-xl border-2 transition-all duration-300 ${
          isListening
      ...
      {transcript && (
        <div className="mt-3 p-3 bg-white border border-gray-200 rounded-lg">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm font-medium text-gray-700">{t('voice.transcript')}:</span>
            {!autoSubmit && (
              <button
                onClick={() => {
                  onTranscript(transcript);
